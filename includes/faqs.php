            ...
            <div class="col-12 col-xl-11">
                <div class="accordion radius-pill-10 bg-white" id="accordionFaq">
                    <div class="accordion-item radius-pill-10 accordion-active mb-3">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="faqOne" data-bs-parent="#accordionFaq">
                            <div class="accordion-body">
                                <p>Our invoices are emailed upon completion of the job. Payment is due within 7 days and can be made via bank transfer, bank deposit, cheque, cash or credit card (Visa and MasterCard).</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item radius-pill-10 mb-3">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="faqSix" data-bs-parent="#accordionFaq">
                            <div class="accordion-body">
                                <p>Our invoices are emailed upon completion of the job. Payment is due within 7 days and can be made via bank transfer, bank deposit, cheque, cash or credit card (Visa and MasterCard).</p>
                            </div>
                        </div>
                    ...
                    <div class="text-center pt-3 pt-xl-5 mt-4">
                        <a class="btn btn-secondary" href="#" title="View all Faq">View ALl QUestions</a>
                    </div>
                </div>
