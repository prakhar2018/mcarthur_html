        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-7">
                <div class="banner-content text-center">
                    <h1>Suburbs</h1>                    
                    <p>Looking for a plumbing services expert near you? Check out the list of suburbs. Book plumbing experts today. </p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 card-outer mb-4 mb-xl-4">
                <div class="card text-center h-100">
                    <div class="mx-auto text-white circle d-flex justify-content-center align-items-center mb-4">
                       <i class="icon-sink-274"></i>
                    </div>
                    <div class="content text-uppercase position-relative">
                       <h3>Sinks and basins</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 card-outer mb-4 mb-xl-4">
                <div class="card text-center h-100">
                    <div class="mx-auto text-white circle d-flex justify-content-center align-items-center mb-4">
                       <i class="icon-inspecting"></i>
                    </div>
                    <div class="content text-uppercase position-relative">
                        <h3>Pre-purchase plumbing inspections</h3>
                    </div>
                </div>
            </div>
...
<section class="section-5 position-relative py-lg-5">
    ...
    <div class="shap-large mt-5 lazy w-100" data-bg="images/shap-large.png"></div>
</section>
<section class="section-17 py-5">
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-12 col-lg-11">
                <div class="section-heading shap text-center">
        ...
        <div class="row mt-3 mt-lg-5">
            ...
            <div class="col-12 col-lg-4 order-1 order-lg-2">
                <div class="d-flex justify-content-center align-items-start h-100">
                    <img class="lazy" data-src="images/blue-drop.jpg" alt="" width="" height="">
                </div>
            </div>
